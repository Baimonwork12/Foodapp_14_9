...
class _AdddatashopState extends State<Adddatashop> {
  ...
  final formKey = GlobalKey<FormState>();
   ...
   CollectionReference collectionUser =
      FirebaseFirestore.instance.collection("datashop");
...
'ที่อยู่':Address.text,
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: Text('เพิ่มข้อมูลร้านค้า')),
      body: Form(
        key: formKey,
        child: Column(
        children: [
          Padding(
            ...
            child: TextFormField(controller: nameshop,
          ...
          OutlinedButton(onPressed: (){
            sendUserDataToDB(); Navigator.push(context, MaterialPageRoute(builder: (context)=>MyNavigator1()));
